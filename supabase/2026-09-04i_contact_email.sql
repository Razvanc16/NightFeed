-- Adaugă emailul de contact la datele cerute pentru evenimentele oficiale
-- (pe lângă nume/telefon/social, deja existente).

begin;

alter table public.posted_events add column if not exists contact_email text;
    ...
    <tr>
      <td style="padding:20px 28px;">
        <table role="presentation" width="100%%" style="border-collapse:collapse;">
          ...
          <tr>
            <td style="padding:5px 0;font-size:13px;color:#71717a;vertical-align:top;">Email</td>
            <td style="padding:5px 0;font-size:13px;color:#18181b;font-weight:500;text-align:right;">%s</td>
          </tr>
          <tr>
