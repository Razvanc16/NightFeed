...
export default function LegalPage({ onClose }) {
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 10200, background: "#080808", animation: "tabEnter 0.3s cubic-bezier(0.16,1,0.3,1)" }}>
