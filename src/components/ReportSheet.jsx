...
export default function ReportSheet({ event, user, open, onClose }) {
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, background: "rgba(10,10,12,0.98)", borderTop: "2px solid rgba(255,184,0,0.3)", borderRadius: "24px 24px 0 0", transform: open ? "translateY(0)" : "translateY(100%)", transition: "transform 0.35s cubic-bezier(0.32, 0, 0.15, 1)", zIndex: 401, padding: "16px 20px", paddingBottom: "80px", touchAction: "none" }}>
